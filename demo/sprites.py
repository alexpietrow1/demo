...
class Platform(Sprite):
    ...
    def compress(self):
        #gets new image and sets the colorkey
        self.image = self.game.spritesheet.get_image(0, 1988, 145, 57)
        self.image.set_colorkey(BLACK)
    '''CHANGE: FUNCTION FOR UNCOMPRESSING SPRING
        However, it is not used because I couldn't figure out how to manipulate pygame time'''
    def uncompress(self):
        self.image = self.game.spritesheet.get_image(434, 1270, 145, 110)
        self.image.set_colorkey(BLACK)
